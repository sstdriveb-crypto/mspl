...
(async () => {
  ...
  // Ensure we're on HR section by checking for 'HR Administrator' heading or Email label
  ...
  // Try to detect inputs by name attributes or placeholder
  ...
  // Submit form - find a button with text 'Register' or 'Sign up' or 'Create'
  ...
  // Now attempt to login: switch to Login mode if necessary
